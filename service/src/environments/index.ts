...
const MARKETPLACE_DATABASE_HOST: string =
  process.env.MARKETPLACE_DATABASE_HOST || NEED_TO_CONFIGURED;
const MARKETPLACE_DATABASE_NAME: string =
  process.env.MARKETPLACE_DATABASE_NAME || NEED_TO_CONFIGURED;
const MARKETPLACE_DATABASE_USER: string =
  process.env.MARKETPLACE_DATABASE_USER || NEED_TO_CONFIGURED;
const MARKETPLACE_DATABASE_PASSWORD: string =
  process.env.MARKETPLACE_DATABASE_PASSWORD || NEED_TO_CONFIGURED;
const MARKETPLACE_DATABASE_PORT: number =
  +process.env.MARKETPLACE_DATABASE_PORT || 5432;
