...
export class SpentOutpointRuneBalance {
  @PrimaryColumn()
  id!: number;
  ...
  @ManyToOne(
    () => TransactionOut,
    (transactionOut) => transactionOut.spentOutpointRuneBalances,
  )
  @JoinColumn([
  ...
  @ManyToOne(
    ...
    (transactionRuneEntry) => transactionRuneEntry.spentOutpointRuneBalances,
  )
